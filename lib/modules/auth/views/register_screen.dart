                  ...
                  child: Row(
                    children: [
                      ...
                      Expanded(
                        child: GestureDetector(
                          onTap: () {
                           ...
                           // authController.setRole(UserRole.seller);
                          },
                          child: Container(
                            padding: EdgeInsets.symmetric(vertical: 12),
                            decoration: BoxDecoration(
                              // color: authController.selectedRole == UserRole.seller
                      ...
                      Expanded(
                        child: GestureDetector(
                          onTap: () {
                            //authController.setRole(UserRole.reseller);
                          },
                          child: Container(
                            padding: EdgeInsets.symmetric(vertical: 12),
                            decoration: BoxDecoration(
                              // color: authController.selectedRole == UserRole.reseller
                              //     ? theme.colorScheme.primary
                              //     : Colors.transparent,
                              borderRadius: BorderRadius.circular(30),
                            ),
